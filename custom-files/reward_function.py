    ...
    def reward_function(self, params):
        try:
            ...
            if prev_waypoint_index >= 28 and prev_waypoint_index <= 33:
                reward *= 2.25
            if (prev_waypoint_index >= 59 and prev_waypoint_index <= 67) or (prev_waypoint_index >= 72 and prev_waypoint_index <= 76) and (prev_waypoint_index >= 79 and prev_waypoint_index <= 85):
                reward *= 1.50
