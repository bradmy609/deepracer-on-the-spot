...
class Reward:
    ...
    def reward_function(self, params):
        ...
        SUPER_FAST_BONUS = 0
        # 90 degree left turns, 2 exp to hug line, 1.5 mult to set mid priority as more important than speed.
        ...
        # 180 degree right turn, 2 exp to hug line, 2 mult to set highest priority.
            ...
            if steering_angle > 5:
                STEERING_PUNISHMENT = 0.1
        # 180 degree left turns, 2 exp to hug line, 2 mult to set highest priority.
