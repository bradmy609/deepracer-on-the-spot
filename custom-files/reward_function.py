    ...
    def reward_function(self, params):
        try:
            ...
            if prev_waypoint_index >= 23 and prev_waypoint_index <= 27:
                reward *= 1.75
            if prev_waypoint_index >= 28 and prev_waypoint_index <= 32:
                reward *= 2.25
            ...
            if prev_waypoint_index >= 34 and prev_waypoint_index <= 55:
                reward *= 1.5
            if prev_waypoint_index >= 60 and prev_waypoint_index <= 85:
                reward *= 1.5
            if prev_waypoint_index >= 86 and prev_waypoint_index <= 100:
                reward *= 1.25
